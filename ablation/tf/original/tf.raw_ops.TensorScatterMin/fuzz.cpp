...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    try {
        ...
        if (!updates_shape.empty() && !tensor_shape.empty()) {
        ...
        auto tensor_scatter_min = tensorflow::ops::TensorScatterMin(root, tensor_placeholder, indices_placeholder, updates_placeholder);
