...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    try {
        ...
        auto k_scalar = k_tensor.scalar<int32_t>();
        k_scalar() = static_cast<int32_t>(k_val);
        ...
        for (int i = 0; i < diagonal_tensor.dims(); ++i) {
            std::cout << diagonal_tensor.dim_size(i) << " ";
        }
        std::cout << std::endl;
        ...
        auto matrix_set_diag_v3 = tensorflow::ops::MatrixSetDiagV3(
