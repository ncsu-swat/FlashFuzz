...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    try {
        ...
        tensorflow::DataType accum_dtype = parseDataType(data[offset++]);
        ...
        tensorflow::TensorShape momentum_tensor_shape;

        if (!tensorflow::TensorShape::BuildTensorShape(var_shape, &var_tensor_shape).ok()) {
            return 0;
        }
        if (!tensorflow::TensorShape::BuildTensorShape(accum_shape, &accum_tensor_shape).ok()) {
            return 0;
        }
        ...
        tensorflow::Tensor momentum_tensor(var_dtype, momentum_tensor_shape);
        ...
        bool use_nesterov = data[offset++] % 2;

        std::cout << "var_dtype: " << var_dtype << std::endl;
        std::cout << "accum_dtype: " << accum_dtype << std::endl;
        std::cout << "var_shape: ";
        for (auto dim : var_shape) {
            std::cout << dim << " ";
        }
        std::cout << std::endl;
        std::cout << "accum_shape: ";
        for (auto dim : accum_shape) {
            std::cout << dim << " ";
        }
        std::cout << std::endl;
        std::cout << "grad_shape: ";
        ...
        std::cout << "grad_tensor: " << grad_tensor.DebugString() << std::endl;
        std::cout << "indices_tensor: " << indices_tensor.DebugString() << std::endl;
        std::cout << "lr_tensor: " << lr_tensor.DebugString() << std::endl;
        std::cout << "momentum_tensor: " << momentum_tensor.DebugString() << std::endl;
