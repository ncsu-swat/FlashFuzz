...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    try {
        ...
        tensorflow::Tensor gradients_tensor(dtype, tensor_shape);
        tensorflow::Tensor inputs_tensor(dtype, tensor_shape);
        ...
        std::cout << "Num bits: " << num_bits << ", Narrow range: " << narrow_range << std::endl;
        ...
        auto fake_quant_grad = tensorflow::ops::FakeQuantWithMinMaxArgsGradient(
            root, gradients_placeholder, inputs_placeholder, min_val, max_val,
            tensorflow::ops::FakeQuantWithMinMaxArgsGradient::NumBits(num_bits)
        ...
        tensorflow::Status status = session.Run(
            {{gradients_placeholder, gradients_tensor}, {inputs_placeholder, inputs_tensor}},
            {fake_quant_grad}, &outputs);
