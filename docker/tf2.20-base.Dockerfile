...
# Install Bazel 7.4.1 (required by TensorFlow 2.20)
RUN wget https://github.com/bazelbuild/bazel/releases/download/7.4.1/bazel-7.4.1-linux-x86_64 -O /usr/local/bin/bazel && \
    chmod +x /usr/local/bin/bazel

# Clone TensorFlow and checkout version 2.20.0
RUN git clone --branch v2.20.0 https://github.com/tensorflow/tensorflow.git /root/tensorflow --depth 1
