...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        auto thread_pool_handle = tensorflow::ops::Placeholder(root, tensorflow::DT_RESOURCE);
        ...
        // Create the ThreadPoolDataset operation using raw_ops
        tensorflow::Output thread_pool_dataset = tensorflow::Operation(
            root.WithOpName("ThreadPoolDataset"),
            "ThreadPoolDataset",
            {input_dataset_placeholder, thread_pool_handle},
