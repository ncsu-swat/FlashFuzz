...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        // Use raw_ops namespace for MatrixLogarithm
        auto matrix_log_op = tensorflow::ops::Operation(
            root.WithOpName("MatrixLogarithm"),
            "MatrixLogarithm",
            {input_placeholder},
            {{"T", dtype}});
        
        auto output = tensorflow::Output(matrix_log_op, 0);
