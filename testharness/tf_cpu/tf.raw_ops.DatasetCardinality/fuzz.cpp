...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        // Create dataset using raw ops
        std::vector<tensorflow::DataType> output_types = {element_dtype};
        ...
        // Use raw op for DatasetCardinality
        auto cardinality_op = tensorflow::ops::_Unary(
            root.WithOpName("DatasetCardinality"),
            range_dataset,
            "DatasetCardinality"
        );
