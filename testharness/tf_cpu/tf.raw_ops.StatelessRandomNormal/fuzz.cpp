...
tensorflow::DataType parseShapeSeedDataType(uint8_t selector) {
    tensorflow::DataType dtype;
    switch (selector % 2) {
        case 0:
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        tensorflow::DataType shape_dtype = parseShapeSeedDataType(data[offset++]);
        tensorflow::DataType seed_dtype = parseShapeSeedDataType(data[offset++]);
        ...
        auto stateless_random_normal = tensorflow::ops::StatelessRandomNormal(
            root, shape_input, seed_input, output_dtype);
