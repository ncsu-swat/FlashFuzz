...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        tensorflow::Tensor keys_tensor(key_dtype, key_tensor_shape);
        tensorflow::Tensor values_tensor(value_dtype, value_tensor_shape);
        ...
        // Use raw_ops to create the LookupTableImportV2 operation
        tensorflow::Output import_op = tensorflow::ops::Operation(
            root.WithOpName("LookupTableImportV2"),
            "LookupTableImportV2",
        ...
        tensorflow::Status status = session.Run({{table_handle, dummy_resource}}, {}, {import_op.node()->name()}, &outputs);
