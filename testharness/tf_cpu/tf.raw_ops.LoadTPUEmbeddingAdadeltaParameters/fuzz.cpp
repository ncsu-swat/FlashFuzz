...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        tensorflow::Tensor updates_tensor(tensorflow::DT_FLOAT, tensor_shape3);
        fillTensorWithDataByType(updates_tensor, tensorflow::DT_FLOAT, data, offset, size);
        ...
        std::vector<tensorflow::Output> inputs = {
            parameters_input, accumulators_input, updates_input
        };
        
        tensorflow::NodeBuilder builder = tensorflow::NodeBuilder("LoadTPUEmbeddingAdadeltaParameters", "LoadTPUEmbeddingAdadeltaParameters")
            .Input(inputs)
