...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        // Use the raw_ops API through the scope
        auto unique_dataset = tensorflow::ops::ExperimentalUniqueDataset(
            root.WithOpName("UniqueDataset"),
            range_dataset,
            output_types,
            output_shapes
        );
        ...
        tensorflow::Status status = session.Run({unique_dataset}, &outputs);
