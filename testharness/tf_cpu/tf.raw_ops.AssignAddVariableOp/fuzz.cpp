...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        auto init_op = tensorflow::ops::AssignVariableOp(root, var_handle, tensorflow::ops::Const(root, value_tensor));
        
        auto value_input = tensorflow::ops::Const(root, value_tensor);
        
        auto assign_add_op = tensorflow::ops::AssignAddVariableOp(root, var_handle, value_input);
        ...
        ops_to_run = {assign_add_op.operation};
