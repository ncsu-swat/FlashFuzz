...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        auto var_handle = tensorflow::ops::VarHandleOp(root, value_dtype, value_tensor_shape);
        
        auto init_var = tensorflow::ops::AssignVariableOp(root, var_handle, tensorflow::ops::Const(root, value_tensor));
        
        auto assign_sub_op = tensorflow::ops::AssignSubVariableOp(root, var_handle, tensorflow::ops::Const(root, value_tensor));
        
        tensorflow::ClientSession session(root);
        
        std::vector<tensorflow::Operation> init_ops = {init_var};
        ...
        std::vector<tensorflow::Operation> assign_ops = {assign_sub_op};
