...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        predicate_func.set_name("predicate_func");
        
        std::vector<tensorflow::DataType> output_types = {input_dtype};
        std::vector<tensorflow::PartialTensorShape> output_shapes = {tensor_shape};
        
        auto filter_dataset = tensorflow::ops::experimental::FilterDataset(
            root,
            input_dataset,
            other_arguments,
            predicate_func,
