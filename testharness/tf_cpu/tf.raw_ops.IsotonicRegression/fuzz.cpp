...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        // Use raw_ops for IsotonicRegression
        auto isotonic_regression = tensorflow::ops::Operation(
            root.WithOpName("IsotonicRegression"),
            "IsotonicRegression",
            {input_placeholder},
        ...
        tensorflow::Status status = session.Run({{input_placeholder, input_tensor}}, 
                                               {tensorflow::Output(isotonic_regression, 0), 
                                                tensorflow::Output(isotonic_regression, 1)}, 
                                               &outputs);
