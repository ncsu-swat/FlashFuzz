...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        if (!outputs.empty()) {
            std::cout << "Queue created successfully, handle shape: ";
