...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        tensorflow::Tensor thread_pool_tensor(tensorflow::DT_RESOURCE, tensorflow::TensorShape({}));
        ...
        auto thread_pool = tensorflow::ops::Placeholder(root, tensorflow::DT_RESOURCE);
        
        // Use raw_ops namespace for ThreadPoolDataset
        auto thread_pool_dataset = tensorflow::ops::experimental::ThreadPoolDataset(
            root, 
            input_dataset, 
            thread_pool,
            output_types,
        ...
        tensorflow::Status status = session.Run(
            {{input_dataset.node()->name(), input_dataset_tensor},
             {thread_pool.node()->name(), thread_pool_tensor}},
            {thread_pool_dataset.node()->name()},
            &outputs
        );
