...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    try {
        ...
        int64_t total_elements = dense_tensor.NumElements();
        ...
        tensorflow::TensorShape indices_shape({static_cast<int64_t>(indices_data.size())});
        ...
        // Use raw_ops namespace for DenseToCSRSparseMatrix
        auto result = tensorflow::ops::Raw::DenseToCSRSparseMatrix(root, dense_input, indices);
