"""
LLM-driven test harness generator for PyTorch C++ (CPU) using the official Gemini API.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Generate C++ test harnesses via Gemini API")
    ...
    p.add_argument("--api-key", default=os.environ.get("GEMINI_API_KEY"), help="API key for Gemini")
